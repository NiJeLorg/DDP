    ...
    return (
      <div className='story-margin'>
        ...
        <p className='main-text__black'>Downtown Detroit is a desirable place to live and work, and the market price for
          ...
          condominiums available for those who can afford them. However, the Downtown Detroit Partnership and the <a href="https://downtowndetroit.org/business-improvement-zone/" target="_top">Business Improvement Zone</a> recognize that really great places offer housing for people of all incomes, as well
