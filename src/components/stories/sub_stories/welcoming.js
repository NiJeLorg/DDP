  ...
  render() {
    ...
    return (
      <div className='story-margin'>
        <h1 className="sub-sub-heading__purple" data-story-id="1" data-story-overlay="Clean and Welcoming"><span className='ul-yellow-color'>1.</span>CLEAN AND WELCOMING</h1>
