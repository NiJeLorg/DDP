...
class FloorAreaLineChart extends Component {
  ...
  constructor(props) {
    ...
    componentDidMount() {
        let data = d3.range(0, 2700000, 100000).map(function(v) {
            return {
                x: v,
                y: 0.058 * v
            };
...
export default FloorAreaLineChart;
